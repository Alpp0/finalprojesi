    ...
    @endif
            ...
            <table class="table_deg">
                ...
                @foreach ( $post as $post)
                    <tr>
                        ...
                        <td>
                            <a onclick="return confirm('are you sure to accept this post?')" href="{{url('accept_post',$post->id)}}" class="btn btn-outl
                            ne-secondary">Accept</a>
                        </td>
                        <td>
        ...
        function confirmation(ev){
                ...
                swal({
                    ...
                    text: "You won't be able to revet this delete",
                    icon: "warning",
                    buttons: true,
